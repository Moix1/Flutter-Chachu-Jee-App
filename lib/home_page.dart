    ...
    return new Scaffold(
      ...
      body: Builder(
        builder: (BuildContext context){
          return WebView(
            initialUrl: 'https://chachujee.com/',
            ...
            navigationDelegate: (NavigationRequest request){
              if(request.url.startsWith("https://chachujee.com/")){
...
class SampleMenu extends StatelessWidget{
          ...
          onSelected: (MenuOptions value)
          {
            switch(value)
            {
              ...
              case MenuOptions.navigationDelegate:
                navigationDelegate(controller.data, context);
                break;          
              default:
            }
          },
  ...
  navigationDelegate(WebViewController controller, BuildContext context)
  {
